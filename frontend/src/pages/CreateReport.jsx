      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-14 px-4 sm:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {departments.map((dept, i) => (
            <motion.div
              key={i}
              className="group bg-white border-2 border-gray-100 rounded-2xl shadow-lg hover:shadow-2xl p-6 cursor-pointer flex flex-col items-center transition-all duration-300 hover:border-blue-400"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="w-24 h-24 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-inner flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <img
                  src={dept.imageUrl}
                  alt={dept.name}
        ...
        <AnimatePresence>
          {locationDetected && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -10 }}
              className="bg-green-50 border-2 border-green-200 rounded-xl p-3 mb-4 flex items-center gap-2"
            >
              <FaCheckCircle className="text-green-600" />
              <span className="text-green-700 font-medium text-sm">Location detected successfully!</span>
            </motion.div>
          )}
        </AnimatePresence>
